    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
                ...
                >
                    <motion.div
                        className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 rounded-2xl overflow-hidden flex-shrink-0 mx-auto md:mx-0"
                    ...
                    <div className="flex-1 flex flex-col justify-center text-center md:text-left">
                        ...
                        <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
                            ...
                            RestfulAPI- bringing ideas to life from concept to production
                ...
                >
                    ...
                    <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
                        I'm a Software Engineer, Full stack developer, and Ai enthusiast
                        I love DSA and my primary language is C++ and Python  solved 
                        more than 275+ questions on leetcode....
                    </p>
